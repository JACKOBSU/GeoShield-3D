...
def compute_distances_to_disks(
    ...
    # If d_center <= R, projection is inside the disk; closest point is P_proj (factor = 1.0)
    # If d_center > R, projection is outside; closest point is on the boundary disk circle (factor = R / d_center)
